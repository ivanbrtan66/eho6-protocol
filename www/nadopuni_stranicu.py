    ...
    <div class="maska-phase">
      ...
      <div>
        ...
        <p>The anchor runs its own STUN and a signed rendezvous board; peers measure their NAT,
           ...
           single point of failure rather than relocating it.</p>
      </div>
      <span class="maska-pill partial">In progress</span>
    </div>
    <div class="maska-phase">
...
""" + DIJAGRAM + """
  ...
  <p class="maska-measured">
    ...
    <b>4 ms</b> &#183; full name resolution including PULL <b>14 ms</b> &#183; <b>134 tests</b>,
    standard library only, no network egress. Ed25519 is checked against RFC&nbsp;8032 &sect;7.1
    vectors and X25519 against RFC&nbsp;7748 &sect;5.2 plus a cross-check against OpenSSL.
    F4's own test suite and the <code>medijapos</code> field pilot are still open &mdash; the
    pass criterion was set before the measurement: seven days with both paths measured in
    parallel and no watchdog alarm.
  </p>
</section>
"""
